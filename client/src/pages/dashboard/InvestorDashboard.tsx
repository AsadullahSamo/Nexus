  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Link to="/meetings">
          <Card className="bg-primary-50 border border-primary-100 hover:shadow-md transition-shadow">
            <CardBody>
        ...
        <Link to="/messages">
          <Card className="bg-secondary-50 border border-secondary-100 hover:shadow-md transition-shadow">
            <CardBody>
              <div className="flex items-center">
        ...
        <Link to="/documents">
          <Card className="bg-accent-50 border border-accent-100 hover:shadow-md transition-shadow">
            <CardBody>
              <div className="flex items-center">
        ...
        <Link to="/payments">
          <Card className="bg-success-50 border border-success-100 hover:shadow-md transition-shadow">
            <CardBody>
              <div className="flex items-center">
